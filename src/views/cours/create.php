...
<body>
  ...
  <div class="main--content">
    ...
    <form action="/cours/new" method="post" enctype="multipart/form-data" id="courseForm">
      ...
      <div class="form-group">
        ...
        <select id="formation_id" name="formation_id" class="form-control" required onchange="chargerSousFormations()">
          ...
          foreach ($formations as $f) {
            echo '<option value="' . htmlspecialchars($f->getId_formation()) . '">' . htmlspecialchars($f->getNom_formation()) . '</option>';
          }
  ...
  <script>
    ...
    function chargerSousFormations() {
      ...
      if (formationId) {
        ...
        fetch('/sousformation/' + formationId)
