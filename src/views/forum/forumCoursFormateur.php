...
<head>
    ...
    <link rel="stylesheet" href="<?= URL_ROOT ?>asset/css/styles/forum.css">
    ...
    <div class="main--content">
        <div class="header--wrapper">
            <div class="header--title">
                <a href="/cours/formateur" class="btn btn-back"><i class="fas fa-arrow-left"></i> Retour</a>
                <div>
                    <!-- <span>Primary</span> -->
                    <h4>Forum du cours : <?php echo htmlspecialchars($cours['titre']); ?></h4>
                </div>
            </div>
            <div class="user--info">
            ...
            <?php else: ?>
                ...
                <?php foreach ($forums as $forum): ?>
                    <div class="forum-card">
                        ...
                        <form method="post" class="form-group" action="/post/new">
